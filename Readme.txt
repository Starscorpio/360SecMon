...
Prerequisities to setup the project:-
	- Should have python installed. (should be python3)
	- Should have pip3 tool installed.
	- Should have django framework installed.

1. Install python:-
	- sudo apt install python3-pip (Linux)
	- Install python directly from website (along with the pip3 tool): python.org (windows)

2. Drag/Copy the entire folder over to your filesystem.
...
5. To create superuser user the command:-
	- python3 manage.py createsuperuser (not necessary)


6. Run commands to migrate database:-
